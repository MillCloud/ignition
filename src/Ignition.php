...
use MillCloud\FlareClient\FlareMiddleware\AddDocumentationLinks;
use MillCloud\FlareClient\FlareMiddleware\AddSolutions;
...
use MillCloud\Ignition\Contracts\SolutionProviderRepository as SolutionProviderRepositoryContract;
use MillCloud\Ignition\ErrorPage\ErrorPageViewModel;
use MillCloud\Ignition\ErrorPage\Renderer;
use MillCloud\Ignition\Solutions\SolutionProviders\BadMethodCallSolutionProvider;
use MillCloud\Ignition\Solutions\SolutionProviders\MergeConflictSolutionProvider;
use MillCloud\Ignition\Solutions\SolutionProviders\SolutionProviderRepository;
use MillCloud\Ignition\Solutions\SolutionProviders\UndefinedPropertySolutionProvider;
use Throwable;
