...
namespace MillCloud\Ignition\ErrorPage;
...
use MillCloud\Ignition\Solutions\SolutionTransformer;
use Throwable;
...
class ErrorPageViewModel
{
     ...
     * @param \MillCloud\Ignition\Config\IgnitionConfig $ignitionConfig
     * @param \MillCloud\FlareClient\Report $report
